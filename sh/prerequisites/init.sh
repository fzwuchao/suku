...
docker run --name suku-mysql -v ${confDir}:/etc/mysql/conf.d -v ${dataDir}:/var/lib/mysql -e MYSQL_ROOT_PASSWORD=ZY1305@OULAN -e TZ=Asia/Shanghai -p 3306:3306 -d mysql:8.0.21
