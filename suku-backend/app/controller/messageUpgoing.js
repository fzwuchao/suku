...
class MessageUpgoingController extends BaseController {

  async getMessageUpgoinglist() {
    const { ctx } = this;
    ...
    const result = await ctx.service.messageUpgoing.getMessageUpgoingPage(request.query);
    this.success(result, '');
  }
...
module.exports = MessageUpgoingController;
