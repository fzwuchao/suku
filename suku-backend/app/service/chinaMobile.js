...
const api = {
  ...
  query: {
    ...
    sim_communication_function_status: '/etc/query/sim-communication-function-status',
    sim_data_margin: '/etc/query/sim_data_margin',
    sim_voice_margin: '/etc/query/sim-voice-margin',
    sim_voice_usage: '/etc/query/sim-voice-usage',
    sim_data_usage_monthly_batch: '/etc/query/sim-data-usage-monthly/batch',
  },
  change: {
  ...
  operate: {
    sim_communication_function_batch: '/etc/operate/sim-communication-function/batch',
    card_bind_by_bill_batch: '/etc/operate/card-bind-by-bill/batch',
    sim_call_function: '/etc/operate/sim-call-function',
  },
};
